        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
          ...
          <form (ngSubmit)="iniciarSesion()" class="p-6 space-y-4 text-xs" novalidate>
            ...
            <button type="submit"
                    ...
                    class="w-full bg-rose-600 hover:bg-rose-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-2.5 rounded-lg shadow-md shadow-rose-200 transition min-h-[44px]">

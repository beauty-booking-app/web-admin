    ...
    <div class="p-6 space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <button (click)="guardar()"
                ...
                class="bg-rose-700 hover:bg-rose-800 disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold px-5 py-2 rounded-lg text-xs shadow-md shadow-rose-200 transition flex items-center gap-2"
            ...
            <div class="px-5 py-3.5 flex items-center gap-4"
              ...
              @if (franja.activo) {
                <div class="flex items-center gap-2 text-xs">
                  ...
                  <span class="text-slate-500 font-medium">a</span>
                  <input type="time"
                ...
                <span class="text-xs text-slate-500 font-medium italic">No Laboral</span>
              }
            </div>
          }
        </div>
      ...
      <div class="bg-slate-50 border border-slate-200 rounded-xl px-5 py-4 text-xs text-slate-600">
        ...
        @if (horariosService.diasCerrados().length > 0) {
          ...
          <p class="text-slate-500 italic">No hay días cerrados configurados.</p>
        }
      </div>
      }
    </div>
